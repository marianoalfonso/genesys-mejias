...
<head>
    ...
    <!-- css personalizado -->
    <link rel="stylesheet" href="turnosProfesionalEdit.css">
...
<div class="container d-flex justify-content-center">
    <form action="turnosProfesionalCrud.php" method="post" style="width: 50vw; min-width: 300px;">
    ...
    <script src="turnosProfesionalEdit.js"></script>
    <!-- bootstrap -->
